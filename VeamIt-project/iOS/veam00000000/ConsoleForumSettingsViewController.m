//
//  ConsoleForumSettingsViewController.m
//  veam00000000
//
...
@interface ConsoleForumSettingsViewController ()

@end

@implementation ConsoleForumSettingsViewController
...
- (void)reloadValues
{
    ...
    [titleInputBarView setInputValue:contents.templateForum.title] ;
}
...
- (void)didChangeTextInputValue:(ConsoleTextInputBarView *)view value:(NSString *)value
{
    switch (view.tag) {
        case CONSOLE_VIEW_TITLE:
            [[ConsoleUtil getConsoleContents] setTemplateForumTitle:value] ;
            break;
