//
//  ConsoleWebSettingsViewController.m
//  veam00000000
//
...
@interface ConsoleWebSettingsViewController ()

@end

@implementation ConsoleWebSettingsViewController
...
- (void)reloadValues
{
    ...
    [titleInputBarView setInputValue:contents.templateWeb.title] ;
}
...
- (void)didChangeTextInputValue:(ConsoleTextInputBarView *)view value:(NSString *)value
{
    switch (view.tag) {
        case CONSOLE_VIEW_TITLE:
            [[ConsoleUtil getConsoleContents] setTemplateWebTitle:value] ;
            break;
