//
//  SellVideoPurchaseViewController.m
//  veam31000015
//
...
@interface SellVideoPurchaseViewController ()

@end

@implementation SellVideoPurchaseViewController
...
- (void)viewDidLoad {
    ...
    NSString *description = sellVideo.description ;
    ...
    if(!isBought){
        ...
        [label setText:sellVideo.buttonText] ;
...
- (void)purchaseButtonTapped
{
    ...
    if([VeamUtil isVeamConsole]){
        ...
        [inAppPurchaseManager purchaseProductWithID:sellVideo.productId] ;
    }
...
-(void)alertView:(UIAlertView*)alertView clickedButtonAtIndex:(NSInteger)buttonIndex
{
    ...
    if(buttonIndex == 0){
        ...
        [VeamUtil verifySellVideoReceipt:[NSString stringWithFormat:@"TEST_TOKEN_%@",sellVideo.productId] clearIfExpired:YES forced:YES] ;
