//
//  SellPdfPurchaseViewController.m
//  veam31000000
//
...
@interface SellPdfPurchaseViewController ()

@end

@implementation SellPdfPurchaseViewController
...
- (void)viewDidLoad {
    ...
    NSString *description = sellPdf.description ;
    ...
    if(!isBought){
        ...
        [label setText:sellPdf.buttonText] ;
...
{
    [self startPurchase] ;
    if([VeamUtil isVeamConsole] || [VeamUtil isTestPurchase]){
        ...
        //NSLog(@"purchaseProductWithID : %@",sellPdf.productId) ;
        [inAppPurchaseManager purchaseProductWithID:sellPdf.productId] ;
    }
...
-(void)alertView:(UIAlertView*)alertView clickedButtonAtIndex:(NSInteger)buttonIndex
{
    ...
    if(buttonIndex == 0){
        ...
        [VeamUtil verifySellPdfReceipt:[NSString stringWithFormat:@"TEST_TOKEN_%@",sellPdf.productId] clearIfExpired:YES forced:YES] ;
...
-(void) providePurchasedContent:(NSString *)productID
{
    ...
    isBought = YES ;
    [VeamUtil setSellPdfPurchased:YES] ;
