...
@interface PostVideoCommentViewController ()
...
- (void)viewDidLoad
{
    ...
    [self setViewName:[NSString stringWithFormat:@"PostVideoComment/%@/",videoId]] ;
    ...
    //NSLog(@"%@::viewDidLoad end",NSStringFromClass([self class])) ;
...
{
    NSURL *url = [VeamUtil getApiUrl:@"video/postcomment"] ;
    ...
    NSString *signature = [VeamUtil sha1:[NSString stringWithFormat:@"VEAM_%@_%d_%@_%@",uid,socialUserId,videoId,comment]] ;
    
    NSString *params ;
    params = [NSString stringWithFormat:@"u=%@&sid=%d&v=%@&c=%@&s=%@",uid,socialUserId,videoId,urlEncodedComment,signature] ;
