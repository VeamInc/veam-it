//
//  ConsoleEditSectionDescriptionViewController.m
//  veam00000000
//
...
#define CONSOLE_SECTION_DESCRIPTION_KEY    @"section_0_description"


@interface ConsoleEditSectionDescriptionViewController ()

@end

@implementation ConsoleEditSectionDescriptionViewController
...
- (void)reloadValues
{
    // set title
    contents = [ConsoleUtil getConsoleContents] ;
    NSString *description = [contents getValueForKey:CONSOLE_SECTION_DESCRIPTION_KEY] ;
...
- (BOOL)isValueChanged
{
    ...
    if(
       ![description isEqualToString:[contents getValueForKey:CONSOLE_SECTION_DESCRIPTION_KEY]]
       ){
        //NSLog(@"modified") ;
        retValue = YES ;
    }
...
- (void)saveValues
{
    ...
    [contents setAppData:[descriptionInputBarView getInputValue] name:CONSOLE_SECTION_DESCRIPTION_KEY] ;
}
