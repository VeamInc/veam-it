//
//  ConsoleUpdatePreparingSellSectionItemStatusHandler.m
//  veam00000000
//
...
@implementation ConsoleUpdatePreparingSellSectionItemStatusHandler
    ...
    if([results count] >= 2){
        ...
        if([result isEqualToString:@"OK"]){
            ...
            for(int index = 0 ; index < numberOfElements ; index++){
                ...
                if([values count] >= 3){
                    NSString *sellSectionItemId = [values objectAtIndex:0] ;
                    NSString *status = [values objectAtIndex:1] ;
                    NSString *statusText = [values objectAtIndex:2] ;
                    SellSectionItem *sellSectionItem = [contents getSellSectionItemForId:sellSectionItemId] ;
