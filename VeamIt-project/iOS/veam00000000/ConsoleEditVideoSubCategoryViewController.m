//
//  ConsoleEditVideoSubCategoryViewController.m
//  veam00000000
//
...
@interface ConsoleEditVideoSubCategoryViewController ()

@end

@implementation ConsoleEditVideoSubCategoryViewController
...
- (void)didTapRightText
{
    ...
    if(videoSubCategory == nil){
        //NSLog(@"new sub category c=%@",videoCategory.videoCategoryId) ;
        videoSubCategory = [[VideoSubCategory alloc] init] ;
        videoSubCategory.videoCategoryId = videoCategory.videoCategoryId ;
    }
    //NSLog(@"name=%@",[titleInputBarView getInputValue]) ;
    [videoSubCategory setName:[titleInputBarView getInputValue]] ;
    [[ConsoleUtil getConsoleContents] setVideoSubCategory:videoSubCategory] ;
