//
//  ConsoleEditSellAudioViewController.m
//  veam00000000
//
...
@interface ConsoleEditSellAudioViewController ()

@end

@implementation ConsoleEditSellAudioViewController
...
- (void)reloadValues
{
    ...
    if(sellAudio != nil){
        description = sellAudio.description ;
        price = sellAudio.price ;
    }
    ...
    if((audio == nil) || (sellAudio == nil)){
        ...
        if(isSellSection){
            ...
            if(
               ...
               ![imageUrl isEqualToString:audio.imageUrl] ||
               ![pdfUrl isEqualToString:audio.linkUrl] ||
               ![description isEqualToString:sellAudio.description] ||
               ![price isEqualToString:sellAudio.price]
               ){
                //NSLog(@"modified") ;
                retValue = YES ;
            }
...
- (BOOL)saveValues
{
    ...
    if(sellAudio == nil){
        sellAudio = [[SellAudio alloc] init] ;
    }
...
- (void)doUpdate
{
    ...
    [[ConsoleUtil getConsoleContents] setSellAudio:sellAudio audioCategoryId:audioCategory.audioCategoryId audioTitle:audio.title audioSourceUrl:audio.dataUrl audioImageUrl:audio.imageUrl audioLinkUrl:audio.linkUrl] ;
