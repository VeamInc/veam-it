//
//  ConsoleSellVideoTableViewCell.m
//  veam00000000
//
...
@implementation ConsoleSellVideoTableViewCell
...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier sellVideo:(SellVideo *)sellVideo isLast:(BOOL)isLast
{
    ...
    if (self) {
        ...
        if([sellVideo.status isEqualToString:VEAM_SELL_VIDEO_STATUS_WAITING]){
        ...
        self.titleLabel.text = [[ConsoleUtil getConsoleContents] getVideoForId:sellVideo.videoId].title ;
        ...
        self.priceLabel.text = sellVideo.priceText ;
        ...
        if([sellVideo.status isEqualToString:VEAM_SELL_VIDEO_STATUS_READY]){
            ...
            NSAttributedString *astr = [[NSAttributedString alloc]
                                        initWithString:sellVideo.statusText
                                        attributes:@{
            ...
            if([sellVideo.status isEqualToString:VEAM_SELL_VIDEO_STATUS_PREPARING] ||
               [sellVideo.status isEqualToString:VEAM_SELL_VIDEO_STATUS_SUBMITTING]){
                [self blinkLabel:self.statusLabel] ;
            }
            
            if([sellVideo.status isEqualToString:VEAM_SELL_VIDEO_STATUS_SUBMITTING]){
