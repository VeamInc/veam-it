//
//  ConsoleEditSectionPaymentDescriptionViewController.m
//  veam00000000
//
...
#define CONSOLE_SECTION_PAYMENT_DESCRIPTION_KEY    @"section_payment_0_description"


@interface ConsoleEditSectionPaymentDescriptionViewController ()

@end

@implementation ConsoleEditSectionPaymentDescriptionViewController
...
- (void)reloadValues
{
    // set title
    contents = [ConsoleUtil getConsoleContents] ;
    NSString *description = [contents getValueForKey:CONSOLE_SECTION_PAYMENT_DESCRIPTION_KEY] ;
...
- (BOOL)isValueChanged
{
    ...
    if(
       ![description isEqualToString:[contents getValueForKey:CONSOLE_SECTION_PAYMENT_DESCRIPTION_KEY]]
       ){
        //NSLog(@"modified") ;
        retValue = YES ;
    }
...
- (void)saveValues
{
    ...
    [contents setAppData:[descriptionInputBarView getInputValue] name:CONSOLE_SECTION_PAYMENT_DESCRIPTION_KEY] ;
}
...
/*
 ...
 [viewController setCustomizeKind:VEAM_CONSOLE_CUSTOMIZE_KIND_SECTION] ;
 [viewController setHideHeaderBottomLine:YES] ;
 [viewController setHeaderStyle:VEAM_CONSOLE_HEADER_STYLE_BACK] ;
 [viewController setHeaderTitle:@"Exclusive - Customize"] ;
