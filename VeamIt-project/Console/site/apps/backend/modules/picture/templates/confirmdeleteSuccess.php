<b>Are you sure you want to remove this picture?</b><br />
<br />
<?php echo link_to('Cancel','picture/show') ?><br />
<br />
<table border="1" bgcolor="#FF0000">
	...
	<?php foreach($pictures as $picture): ?>
		<tr>
			...
			<td><?php echo link_to('Remove','picture/delete?id=' . $picture->getId()) ?></td>
		</tr>
	<?php endforeach ?>
</table>
<br />
