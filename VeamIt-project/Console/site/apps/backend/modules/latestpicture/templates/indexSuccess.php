<table border="1">
	<tr><td>ID</td><td>Forum</td><td>User</td><td>Likes</td><td>Image</td><td>Comments</td><td>CreatedAt</td></tr>
...
<?php echo link_to('Next page','latestpicture/index?p=' . ($pageNo+1) . "&a=" . $appId) ?>
