					...
					<div class="widget-title">
						<h5 class="widgetheading"><?php echo __('APP SETTINGS') ?>
							<span class="portfolio-image">
								<a class="hover-wrap fancybox" data-fancybox-group="gallery" title="Veam" href="/images/admin/help/template_help.jpg"><i class="icon-question-sign"></i></a>
	...
	<div id="sub-footer">
		<div class="container">
			<div class="row bottom3">
				<div class="span7">
					<div class="copyright">
						<p><span class="first">Copyright (c) 2016 Veam.inc </span></p>
					</div>
				</div>
