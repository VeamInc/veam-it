...
<?php if(0): ?>
						<?php $accordionTarget = ACCORDION_TOGGLE_TARGET_DASHBOARD_PAYPERCONTENT ?>
						<div class="accordion-group">
							<div class="accordion-heading">
								<a class="<?php echo AdminTools::getAccordionToggleClass($accordionTarget,$moduleName,$actionName) ?>" data-toggle="collapse" data-parent="#accordion1" href="#collapse1-7">
								<i class="<?php echo AdminTools::getAccordionToggleIconClass($accordionTarget,$moduleName,$actionName) ?>"></i> Pay Per Content </a>
							</div>
							<div id="collapse1-7" class="<?php echo AdminTools::getAccordionToggleCollapseClass($accordionTarget,$moduleName,$actionName) ?>">
								<div class="accordion-inner">
									<ul class="cat">
										<li class="<?php echo AdminTools::getAccordionInnerListClass(ACCORDION_INNER_TARGET_DASHBOARD_PAYPERCONTENT_LISTVIDEO,$moduleName,$actionName) ?>"><i class="icon-angle-right"></i><?php echo AdminTools::link_to_admin_preview('Video', 'paypercontent/listvideo') ?></li>
										<li class="<?php echo AdminTools::getAccordionInnerListClass(ACCORDION_INNER_TARGET_DASHBOARD_PAYPERCONTENT_LISTAUDIO,$moduleName,$actionName) ?>"><i class="icon-angle-right"></i><?php echo AdminTools::link_to_admin_preview('Audio', 'paypercontent/listaudio') ?></li>
										<li class="<?php echo AdminTools::getAccordionInnerListClass(ACCORDION_INNER_TARGET_DASHBOARD_PAYPERCONTENT_LISTPDF,$moduleName,$actionName) ?>"><i class="icon-angle-right"></i><?php echo AdminTools::link_to_admin_preview('PDF', 'paypercontent/listpdf') ?></li>
									</ul>
								</div>
							</div>
						</div>
