...
<div class="span9 column">
	...
	<form id="contactform" action="<?php echo url_for('creator/addnew') ?>" method="post" class="validateform" name="send-contact">
		...
		<div class="row">
			...
			<div class="span9 field">
				<input name="y" placeholder="* Enter YouTube user name" data-rule="maxlen:1" data-msg="Please enter at least 1 chars" type="text" <?php if($password){echo sprintf('value="%s"',$youtubeUserName);} ?>>
				<div class="validation"></div>
			</div>
