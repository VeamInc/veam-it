					...
					<div class="bottom-article-no-margin">
						<ul class="meta-post">
							...
							<?php else: ?>
								...
								<li><i class="icon-ok"></i><?php echo AdminTools::link_to_admin_preview("Mark as solved", "inquiry/setstatus", array("onclick"=>'return confirm("Mark this inquiry as solved?")',"query_string"=>sprintf("i=%d&t=%s&s=3",$inquirySet->getId(),$inquirySet->getToken()))) ; ?></li>
							<?php endif ?>
							<?php endif ?>
