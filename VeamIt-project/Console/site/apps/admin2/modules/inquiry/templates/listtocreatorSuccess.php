...
<div class="span9 column">
	<div class="widget-title"><h5 class="widgetheading">Messages to youtuber</h5></div>
						...
						<div class="accordion-group">
							...
							<div id="collapse-comment<?php echo $inquirySet->getId() ?>" class="accordion-body collapse">
								<div class="accordion-inner">
									...
									<h6><span><?php echo $inquiry->getCreatedAt() ?></span> <?php echo $inquiry->getKind()==2?$inquirySet->getEmail():$inquiry->getUserName() ?></h6>
