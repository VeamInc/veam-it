...
<div class="span9 column">
	<div class="widget-title"><h5 class="widgetheading"><?php echo __('Contents') ?></h5></div>
		<a href="/creator.php/subscription/addnewvideoforsubscription"><span class="pull-right btn btn-theme"><i class="icon-plus-sign"></i><?php echo __('Add New Video') ?></span></a><br /><br />
		<a href="/creator.php/subscription/addnewaudioforsubscription"><span class="pull-right btn btn-theme"><i class="icon-plus-sign"></i><?php echo __('Add New Audio') ?></span></a>
