			...
			<div class="media-content">
				...
				<div class="bottom-article-no-margin">
					<ul class="meta-post">
						...
						<li><i class="icon-user"></i><?php echo $creator->getFirstName() . ' ' . $creator->getLastName() ?></li>
						<li><i class="icon-pencil"></i><?php echo AdminTools::link_to_admin_preview('Edit', "creator/inputedit", array("class"=>"inactive", "query_string"=>sprintf("c=%d",$creator->getId()))) ; ?></li>
					</ul>
				</div>
			</div>
		</div>
