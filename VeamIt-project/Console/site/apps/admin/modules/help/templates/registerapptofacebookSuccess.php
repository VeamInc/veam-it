	...
	<div class="widget-title"><h5 class="widgetheading"><?php echo $appProcess->getName() ?></h5></div>
		<table class="table">
			<tbody>
				...
				<tr><td><?php echo $lineNo++ ?></td><td>Click on the [+Add Platform]</td></tr>
				<tr><td><?php echo $lineNo++ ?></td><td>Click on the [Android]</td></tr>
				<tr><td><?php echo $lineNo++ ?></td><td>Enter "<strong>co.veam.veam<?php echo $app->getId() ?></strong>" for [Google Play Package Name]</td></tr>
				<tr><td><?php echo $lineNo++ ?></td><td>Enter "<strong>co.veam.veam<?php echo $app->getId() ?>.SettingsActivity</strong>" for [Class Name]</td></tr>
				<tr><td><?php echo $lineNo++ ?></td><td>Enter "<strong>__KEY_HASH__</strong>" for [Key Hashes]</td></tr>
				<tr><td><?php echo $lineNo++ ?></td><td>Add "<strong>__KEY_HASH__</strong>" for [Key Hashes]</td></tr>
				<tr><td><?php echo $lineNo++ ?></td><td>Add "<strong>__KEY_HASH__</strong>" for [Key Hashes]</td></tr>
				<tr><td><?php echo $lineNo++ ?></td><td>Add "<strong>__KEY_HASH__</strong>" for [Key Hashes]</td></tr>
				<tr><td><?php echo $lineNo++ ?></td><td>Change [Single Sign On] to "<strong>YES</strong>"</td></tr>
				...
				<tr><td><?php echo $lineNo++ ?></td><td>Click on the [Save Changes]</td></tr>
				<tr><td><?php echo $lineNo++ ?></td><td>Click on the [App Review]</td></tr>
				<tr><td><?php echo $lineNo++ ?></td><td>Change [Make <?php echo $app->getName() ?> public?] to "<strong>YES</strong>"</td></tr>
