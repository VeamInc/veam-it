	...
	<div class="widget-title"><h5 class="widgetheading"><?php echo $appProcess->getName() ?></h5></div>
		<table class="table">
			<tbody>
				...
				<tr><td><?php echo $lineNo++ ?></td><td>Upload the screenshot image file downloaded from <?php echo link_to("here", $app->getScreenShot1(), array("target"=>"_blank")) ; ?></td></tr>
				<tr><td><?php echo $lineNo++ ?></td><td>Upload the icon image file downloaded from <?php echo link_to("here", $smallIconUrl, array("target"=>"_blank")) ; ?></td></tr>
				...
				<tr><td><?php echo $lineNo++ ?></td><td>Click on the [+] button</td></tr>
				<tr><td><?php echo $lineNo++ ?></td><td>Select "<strong>Android</strong>" for [Your App Platform]</td></tr>
				<tr><td><?php echo $lineNo++ ?></td><td>Enter "<strong><?php echo $app->getName() ?> - Android</strong>" for [Your App Name]</td></tr>
				<tr><td><?php echo $lineNo++ ?></td><td>Click on the [Create Application]</td></tr>
				<tr><td><?php echo $lineNo++ ?></td><td>Select "<strong><?php echo $app->getCategory() ?></strong>" for [App Genre]</td></tr>
				<tr><td><?php echo $lineNo++ ?></td><td>Upload the screenshot image file downloaded from <?php echo link_to("here", $app->getScreenShot1(), array("target"=>"_blank")) ; ?></td></tr>
				<tr><td><?php echo $lineNo++ ?></td><td>Upload the icon image file downloaded from <?php echo link_to("here", $smallIconUrl, array("target"=>"_blank")) ; ?></td></tr>
				...
				<tr><td><?php echo $lineNo++ ?></td><td>Click on the [Submit App]</td></tr>
				<tr><td><?php echo $lineNo++ ?></td><td>Click on the [APP SETTINGS]</td></tr>
				<tr><td><?php echo $lineNo++ ?></td><td>Register Kiip App Key/Secret to the <?php echo AdminTools::link_to("register page", "app/enterkiipappforandroid", array("target"=>"_blank","query_string"=>sprintf("a=%d",$app->getId()))) ; ?></td></tr>
