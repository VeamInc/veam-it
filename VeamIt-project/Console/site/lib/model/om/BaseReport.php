...
abstract class BaseReport extends BaseObject  implements Persistent {
	...
	/**
	 * The value for the report_set_id field.
	 * Note: this column has a database default value of: 0
	 * @var        int
	 */
	protected $report_set_id;
	...
	/**
	 * Get the [report_set_id] column value.
	 * 
	 * @return     int
	 */
	public function getReportSetId()
	{
	...
	public function setAppId($v)
	{
		...
		if ($this->app_id !== $v) {
			$this->app_id = $v;
			$this->modifiedColumns[] = ReportPeer::APP_ID;
		}
	...
	public function setSocialUserId($v)
	{
		...
		if ($this->social_user_id !== $v) {
			...
			$this->modifiedColumns[] = ReportPeer::SOCIAL_USER_ID;
		}
	...
	/**
	 * Set the value of [report_set_id] column.
	 * 
	 * @param      int $v new value
	 * @return     Report The current object (for fluent API support)
	 */
	public function setReportSetId($v)
	{
		if ($v !== null) {
			$v = (int) $v;
		}

		if ($this->report_set_id !== $v || $this->isNew()) {
			$this->report_set_id = $v;
			$this->modifiedColumns[] = ReportPeer::REPORT_SET_ID;
		}
	...
	public function setKind($v)
	{
		...
		if ($this->kind !== $v) {
			$this->kind = $v;
			$this->modifiedColumns[] = ReportPeer::KIND;
		}
	...
	public function setContent($v)
	{
		...
		if ($this->content !== $v) {
			$this->content = $v;
			$this->modifiedColumns[] = ReportPeer::CONTENT;
		}
	...
	public function setMessage($v)
	{
		...
		if ($this->message !== $v) {
			$this->message = $v;
			$this->modifiedColumns[] = ReportPeer::MESSAGE;
		}
	...
	public function setDelFlg($v)
	{
		...
		if ($this->del_flg !== $v || $this->isNew()) {
			$this->del_flg = $v;
			$this->modifiedColumns[] = ReportPeer::DEL_FLG;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->report_set_id = ($row[$startcol + 3] !== null) ? (int) $row[$startcol + 3] : null;
			$this->kind = ($row[$startcol + 4] !== null) ? (int) $row[$startcol + 4] : null;
			$this->content = ($row[$startcol + 5] !== null) ? (int) $row[$startcol + 5] : null;
			...
			return $startcol + 10; // 10 = ReportPeer::NUM_COLUMNS - ReportPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($isInsert) {
				...
				// symfony_timestampable behavior
				if (!$this->isColumnModified(ReportPeer::CREATED_AT))
				{
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[3], $arr)) $this->setReportSetId($arr[$keys[3]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ReportPeer::APP_ID)) $criteria->add(ReportPeer::APP_ID, $this->app_id);
		if ($this->isColumnModified(ReportPeer::SOCIAL_USER_ID)) $criteria->add(ReportPeer::SOCIAL_USER_ID, $this->social_user_id);
		if ($this->isColumnModified(ReportPeer::REPORT_SET_ID)) $criteria->add(ReportPeer::REPORT_SET_ID, $this->report_set_id);
		if ($this->isColumnModified(ReportPeer::KIND)) $criteria->add(ReportPeer::KIND, $this->kind);
		if ($this->isColumnModified(ReportPeer::CONTENT)) $criteria->add(ReportPeer::CONTENT, $this->content);
		if ($this->isColumnModified(ReportPeer::MESSAGE)) $criteria->add(ReportPeer::MESSAGE, $this->message);
		if ($this->isColumnModified(ReportPeer::DEL_FLG)) $criteria->add(ReportPeer::DEL_FLG, $this->del_flg);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setReportSetId($this->report_set_id);
