...
/**
 * Base static class for performing query and update operations on the 'sub_category' table.
 *
 * 
 *
...
abstract class BaseSubCategoryPeer {
	...
	const ID = 'sub_category.ID';

	/** the column name for the APP_ID field */
	const APP_ID = 'sub_category.APP_ID';

	/** the column name for the CATEGORY_ID field */
	const CATEGORY_ID = 'sub_category.CATEGORY_ID';

	/** the column name for the NAME field */
	const NAME = 'sub_category.NAME';

	/** the column name for the DISPLAY_ORDER field */
	const DISPLAY_ORDER = 'sub_category.DISPLAY_ORDER';

	/** the column name for the DEL_FLG field */
	const DEL_FLG = 'sub_category.DEL_FLG';

	/** the column name for the CREATED_AT field */
	const CREATED_AT = 'sub_category.CREATED_AT';

	/** the column name for the UPDATED_AT field */
	const UPDATED_AT = 'sub_category.UPDATED_AT';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'AppId', 'CategoryId', 'Name', 'DisplayOrder', 'DelFlg', 'CreatedAt', 'UpdatedAt', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'appId', 'categoryId', 'name', 'displayOrder', 'delFlg', 'createdAt', 'updatedAt', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::APP_ID, self::CATEGORY_ID, self::NAME, self::DISPLAY_ORDER, self::DEL_FLG, self::CREATED_AT, self::UPDATED_AT, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'app_id', 'category_id', 'name', 'display_order', 'del_flg', 'created_at', 'updated_at', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'AppId' => 1, 'CategoryId' => 2, 'Name' => 3, 'DisplayOrder' => 4, 'DelFlg' => 5, 'CreatedAt' => 6, 'UpdatedAt' => 7, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'appId' => 1, 'categoryId' => 2, 'name' => 3, 'displayOrder' => 4, 'delFlg' => 5, 'createdAt' => 6, 'updatedAt' => 7, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::APP_ID => 1, self::CATEGORY_ID => 2, self::NAME => 3, self::DISPLAY_ORDER => 4, self::DEL_FLG => 5, self::CREATED_AT => 6, self::UPDATED_AT => 7, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'app_id' => 1, 'category_id' => 2, 'name' => 3, 'display_order' => 4, 'del_flg' => 5, 'created_at' => 6, 'updated_at' => 7, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(SubCategoryPeer::APP_ID);
		$criteria->addSelectColumn(SubCategoryPeer::CATEGORY_ID);
		$criteria->addSelectColumn(SubCategoryPeer::NAME);
		$criteria->addSelectColumn(SubCategoryPeer::DISPLAY_ORDER);
		$criteria->addSelectColumn(SubCategoryPeer::DEL_FLG);
		$criteria->addSelectColumn(SubCategoryPeer::CREATED_AT);
		$criteria->addSelectColumn(SubCategoryPeer::UPDATED_AT);
	}
	...
	public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
	{
		...
		{
		  call_user_func($sf_hook, 'BaseSubCategoryPeer', $criteria, $con);
		}
	 ...
	 *
	 * @param      SubCategory $value A SubCategory object.
	...
	/**
	 * Method to invalidate the instance pool of all tables related to sub_category
	...
	public static function populateObjects(PDOStatement $stmt)
	{
		...
		$cls = SubCategoryPeer::getOMClass(false);
	...
	{
		return $withPrefix ? SubCategoryPeer::CLASS_DEFAULT : SubCategoryPeer::OM_CLASS;
	}

	/**
	 * Method perform an INSERT on the database, given a SubCategory or Criteria object.
	 *
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseSubCategoryPeer:doInsert:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseSubCategoryPeer', $values, $con))
      {
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseSubCategoryPeer:doInsert:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BaseSubCategoryPeer', $values, $con, $pk);
    }
	...
	/**
	 * Method perform an UPDATE on the database, given a SubCategory or Criteria object.
	 *
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseSubCategoryPeer:doUpdate:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseSubCategoryPeer', $values, $con))
      {
        return $sf_hook_retval;
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseSubCategoryPeer:doUpdate:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BaseSubCategoryPeer', $values, $con, $ret);
    }
	...
	/**
	 * Method to DELETE all rows from the sub_category table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	...
	/**
	 * Method perform a DELETE on the database, given a SubCategory or Criteria object OR a primary key value.
	 *
	...
	static private function getMixerPreSelectHook($method)
	{
	  ...
	  {
	    return sprintf('BaseSubCategoryPeer:%s:%1$s', 'Count' == $match[1] ? 'doCount' : $match[0]);
	  }
