...
abstract class BaseCategory extends BaseObject  implements Persistent {
	...
	public function setAppId($v)
	{
		...
		if ($this->app_id !== $v) {
			$this->app_id = $v;
			$this->modifiedColumns[] = CategoryPeer::APP_ID;
		}
	...
	public function setKind($v)
	{
		...
		if ($this->kind !== $v || $this->isNew()) {
			$this->kind = $v;
			$this->modifiedColumns[] = CategoryPeer::KIND;
		}
	...
	/**
	 * Set the value of [embed] column.
	 * 
	 * @param      int $v new value
	 * @return     Category The current object (for fluent API support)
	 */
	public function setEmbed($v)
	{
		if ($v !== null) {
			$v = (int) $v;
		}

		if ($this->embed !== $v || $this->isNew()) {
			$this->embed = $v;
			$this->modifiedColumns[] = CategoryPeer::EMBED;
		}
	...
	public function setEmbedUrl($v)
	{
		...
		if ($this->embed_url !== $v) {
			$this->embed_url = $v;
			$this->modifiedColumns[] = CategoryPeer::EMBED_URL;
		}
	...
	public function setDisabled($v)
	{
		...
		if ($this->disabled !== $v || $this->isNew()) {
			$this->disabled = $v;
			$this->modifiedColumns[] = CategoryPeer::DISABLED;
		}
	...
	public function setYoutubePlaylistId($v)
	{
		...
		if ($this->youtube_playlist_id !== $v) {
			...
			$this->modifiedColumns[] = CategoryPeer::YOUTUBE_PLAYLIST_ID;
		}
	...
	public function setDisplayOrder($v)
	{
		...
		if ($this->display_order !== $v || $this->isNew()) {
			...
			$this->modifiedColumns[] = CategoryPeer::DISPLAY_ORDER;
		}
	...
	public function setDelFlg($v)
	{
		...
		if ($this->del_flg !== $v || $this->isNew()) {
			$this->del_flg = $v;
			$this->modifiedColumns[] = CategoryPeer::DEL_FLG;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->embed = ($row[$startcol + 4] !== null) ? (int) $row[$startcol + 4] : null;
			$this->embed_url = ($row[$startcol + 5] !== null) ? (string) $row[$startcol + 5] : null;
			$this->disabled = ($row[$startcol + 6] !== null) ? (int) $row[$startcol + 6] : null;
			$this->youtube_playlist_id = ($row[$startcol + 7] !== null) ? (string) $row[$startcol + 7] : null;
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true)
	{
		...
		$result = array(
			...
			$keys[2] => $this->getKind(),
			$keys[3] => $this->getName(),
			$keys[4] => $this->getEmbed(),
			$keys[5] => $this->getEmbedUrl(),
			$keys[6] => $this->getDisabled(),
			$keys[7] => $this->getYoutubePlaylistId(),
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[4], $arr)) $this->setEmbed($arr[$keys[4]]);
		if (array_key_exists($keys[5], $arr)) $this->setEmbedUrl($arr[$keys[5]]);
		if (array_key_exists($keys[6], $arr)) $this->setDisabled($arr[$keys[6]]);
		if (array_key_exists($keys[7], $arr)) $this->setYoutubePlaylistId($arr[$keys[7]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(CategoryPeer::APP_ID)) $criteria->add(CategoryPeer::APP_ID, $this->app_id);
		if ($this->isColumnModified(CategoryPeer::KIND)) $criteria->add(CategoryPeer::KIND, $this->kind);
		if ($this->isColumnModified(CategoryPeer::NAME)) $criteria->add(CategoryPeer::NAME, $this->name);
		if ($this->isColumnModified(CategoryPeer::EMBED)) $criteria->add(CategoryPeer::EMBED, $this->embed);
		if ($this->isColumnModified(CategoryPeer::EMBED_URL)) $criteria->add(CategoryPeer::EMBED_URL, $this->embed_url);
		if ($this->isColumnModified(CategoryPeer::DISABLED)) $criteria->add(CategoryPeer::DISABLED, $this->disabled);
		if ($this->isColumnModified(CategoryPeer::YOUTUBE_PLAYLIST_ID)) $criteria->add(CategoryPeer::YOUTUBE_PLAYLIST_ID, $this->youtube_playlist_id);
		if ($this->isColumnModified(CategoryPeer::DISPLAY_ORDER)) $criteria->add(CategoryPeer::DISPLAY_ORDER, $this->display_order);
		if ($this->isColumnModified(CategoryPeer::DEL_FLG)) $criteria->add(CategoryPeer::DEL_FLG, $this->del_flg);
