...
abstract class BaseBlogCategory extends BaseObject  implements Persistent {
	...
	public function setAppId($v)
	{
		...
		if ($this->app_id !== $v) {
			$this->app_id = $v;
			$this->modifiedColumns[] = BlogCategoryPeer::APP_ID;
		}
	...
	public function setDelFlg($v)
	{
		...
		if ($this->del_flg !== $v || $this->isNew()) {
			$this->del_flg = $v;
			$this->modifiedColumns[] = BlogCategoryPeer::DEL_FLG;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 6; // 6 = BlogCategoryPeer::NUM_COLUMNS - BlogCategoryPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($isInsert) {
				...
				// symfony_timestampable behavior
				if (!$this->isColumnModified(BlogCategoryPeer::CREATED_AT))
				{
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(BlogCategoryPeer::APP_ID)) $criteria->add(BlogCategoryPeer::APP_ID, $this->app_id);
		if ($this->isColumnModified(BlogCategoryPeer::NAME)) $criteria->add(BlogCategoryPeer::NAME, $this->name);
		if ($this->isColumnModified(BlogCategoryPeer::DEL_FLG)) $criteria->add(BlogCategoryPeer::DEL_FLG, $this->del_flg);
