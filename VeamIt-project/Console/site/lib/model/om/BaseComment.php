...
abstract class BaseComment extends BaseObject  implements Persistent {
	...
	public function setAppId($v)
	{
		...
		if ($this->app_id !== $v) {
			$this->app_id = $v;
			$this->modifiedColumns[] = CommentPeer::APP_ID;
		}
	...
	public function setDelFlg($v)
	{
		...
		if ($this->del_flg !== $v || $this->isNew()) {
			$this->del_flg = $v;
			$this->modifiedColumns[] = CommentPeer::DEL_FLG;
		}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(CommentPeer::APP_ID)) $criteria->add(CommentPeer::APP_ID, $this->app_id);
		...
		if ($this->isColumnModified(CommentPeer::DEL_FLG)) $criteria->add(CommentPeer::DEL_FLG, $this->del_flg);
