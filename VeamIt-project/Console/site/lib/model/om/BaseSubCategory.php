...
/**
 * Base class that represents a row from the 'sub_category' table.
 *
 * 
 *
...
abstract class BaseSubCategory extends BaseObject  implements Persistent {
	...
	/**
	 * Initializes internal state of BaseSubCategory object.
	 * @see        applyDefaults()
	 */
	...
	public function setAppId($v)
	{
		...
		if ($this->app_id !== $v) {
			$this->app_id = $v;
			$this->modifiedColumns[] = SubCategoryPeer::APP_ID;
		}
	...
	public function setName($v)
	{
		...
		if ($this->name !== $v) {
			$this->name = $v;
			$this->modifiedColumns[] = SubCategoryPeer::NAME;
		}
	...
	public function setDisplayOrder($v)
	{
		...
		if ($this->display_order !== $v || $this->isNew()) {
			...
			$this->modifiedColumns[] = SubCategoryPeer::DISPLAY_ORDER;
		}
	...
	public function setDelFlg($v)
	{
		...
		if ($this->del_flg !== $v || $this->isNew()) {
			$this->del_flg = $v;
			$this->modifiedColumns[] = SubCategoryPeer::DEL_FLG;
		}
	...
	public function setCreatedAt($v)
	{
		...
		if ( $this->created_at !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = SubCategoryPeer::CREATED_AT;
			}
	...
	public function setUpdatedAt($v)
	{
		...
		if ( $this->updated_at !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = SubCategoryPeer::UPDATED_AT;
			}
		} // if either are not null
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 8; // 8 = SubCategoryPeer::NUM_COLUMNS - SubCategoryPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			...
			foreach (sfMixer::getCallables('BaseSubCategory:delete:pre') as $callable)
			{
			...
			if ($ret) {
				...
				$this->postDelete($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseSubCategory:delete:post') as $callable)
				{
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			// symfony_behaviors behavior
			foreach (sfMixer::getCallables('BaseSubCategory:save:pre') as $callable)
			{
			...
			if ($this->isModified() && !$this->isColumnModified(SubCategoryPeer::UPDATED_AT))
			{
			...
			if ($isInsert) {
				...
				// symfony_timestampable behavior
				if (!$this->isColumnModified(SubCategoryPeer::CREATED_AT))
				{
			...
			if ($ret) {
				...
				$this->postSave($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseSubCategory:save:post') as $callable)
				{
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(SubCategoryPeer::APP_ID)) $criteria->add(SubCategoryPeer::APP_ID, $this->app_id);
		if ($this->isColumnModified(SubCategoryPeer::CATEGORY_ID)) $criteria->add(SubCategoryPeer::CATEGORY_ID, $this->category_id);
		if ($this->isColumnModified(SubCategoryPeer::NAME)) $criteria->add(SubCategoryPeer::NAME, $this->name);
		if ($this->isColumnModified(SubCategoryPeer::DISPLAY_ORDER)) $criteria->add(SubCategoryPeer::DISPLAY_ORDER, $this->display_order);
		if ($this->isColumnModified(SubCategoryPeer::DEL_FLG)) $criteria->add(SubCategoryPeer::DEL_FLG, $this->del_flg);
		if ($this->isColumnModified(SubCategoryPeer::CREATED_AT)) $criteria->add(SubCategoryPeer::CREATED_AT, $this->created_at);
		if ($this->isColumnModified(SubCategoryPeer::UPDATED_AT)) $criteria->add(SubCategoryPeer::UPDATED_AT, $this->updated_at);
	...
	{
	  if (!$callable = sfMixer::getCallable('BaseSubCategory:'.$method))
	  {
	    throw new sfException(sprintf('Call to undefined method BaseSubCategory::%s', $method));
	  }
