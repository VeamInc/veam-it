...
abstract class BaseNotificationPeer {
	...
	const APP_ID = 'notification.APP_ID';
	...
	const DEL_FLG = 'notification.DEL_FLG';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'AppId', 'Message', 'Finished', 'DelFlg', 'CreatedAt', 'UpdatedAt', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'appId', 'message', 'finished', 'delFlg', 'createdAt', 'updatedAt', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::APP_ID, self::MESSAGE, self::FINISHED, self::DEL_FLG, self::CREATED_AT, self::UPDATED_AT, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'app_id', 'message', 'finished', 'del_flg', 'created_at', 'updated_at', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'AppId' => 1, 'Message' => 2, 'Finished' => 3, 'DelFlg' => 4, 'CreatedAt' => 5, 'UpdatedAt' => 6, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'appId' => 1, 'message' => 2, 'finished' => 3, 'delFlg' => 4, 'createdAt' => 5, 'updatedAt' => 6, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::APP_ID => 1, self::MESSAGE => 2, self::FINISHED => 3, self::DEL_FLG => 4, self::CREATED_AT => 5, self::UPDATED_AT => 6, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'app_id' => 1, 'message' => 2, 'finished' => 3, 'del_flg' => 4, 'created_at' => 5, 'updated_at' => 6, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(NotificationPeer::APP_ID);
		$criteria->addSelectColumn(NotificationPeer::MESSAGE);
		$criteria->addSelectColumn(NotificationPeer::FINISHED);
		$criteria->addSelectColumn(NotificationPeer::DEL_FLG);
