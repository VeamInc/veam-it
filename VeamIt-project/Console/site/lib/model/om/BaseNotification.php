...
abstract class BaseNotification extends BaseObject  implements Persistent {
	...
	public function setAppId($v)
	{
		...
		if ($this->app_id !== $v) {
			$this->app_id = $v;
			$this->modifiedColumns[] = NotificationPeer::APP_ID;
		}
	...
	public function setFinished($v)
	{
		...
		if ($this->finished !== $v || $this->isNew()) {
			$this->finished = $v;
			$this->modifiedColumns[] = NotificationPeer::FINISHED;
		}
	...
	public function setDelFlg($v)
	{
		...
		if ($this->del_flg !== $v || $this->isNew()) {
			$this->del_flg = $v;
			$this->modifiedColumns[] = NotificationPeer::DEL_FLG;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->finished = ($row[$startcol + 3] !== null) ? (int) $row[$startcol + 3] : null;
			...
			return $startcol + 7; // 7 = NotificationPeer::NUM_COLUMNS - NotificationPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[3], $arr)) $this->setFinished($arr[$keys[3]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(NotificationPeer::APP_ID)) $criteria->add(NotificationPeer::APP_ID, $this->app_id);
		if ($this->isColumnModified(NotificationPeer::MESSAGE)) $criteria->add(NotificationPeer::MESSAGE, $this->message);
		if ($this->isColumnModified(NotificationPeer::FINISHED)) $criteria->add(NotificationPeer::FINISHED, $this->finished);
		if ($this->isColumnModified(NotificationPeer::DEL_FLG)) $criteria->add(NotificationPeer::DEL_FLG, $this->del_flg);
