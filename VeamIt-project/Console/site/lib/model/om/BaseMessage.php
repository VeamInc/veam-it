...
abstract class BaseMessage extends BaseObject  implements Persistent {
	...
	public function setAppId($v)
	{
		...
		if ($this->app_id !== $v) {
			$this->app_id = $v;
			$this->modifiedColumns[] = MessagePeer::APP_ID;
		}
	...
	public function setVideoId($v)
	{
		...
		if ($this->video_id !== $v) {
			$this->video_id = $v;
			$this->modifiedColumns[] = MessagePeer::VIDEO_ID;
		}
	...
	public function setName($v)
	{
		...
		if ($this->name !== $v) {
			$this->name = $v;
			$this->modifiedColumns[] = MessagePeer::NAME;
		}
	...
	public function setZip($v)
	{
		...
		if ($this->zip !== $v) {
			$this->zip = $v;
			$this->modifiedColumns[] = MessagePeer::ZIP;
		}
	...
	public function setComment($v)
	{
		...
		if ($this->comment !== $v) {
			$this->comment = $v;
			$this->modifiedColumns[] = MessagePeer::COMMENT;
		}
	...
	public function setDelFlg($v)
	{
		...
		if ($this->del_flg !== $v || $this->isNew()) {
			$this->del_flg = $v;
			$this->modifiedColumns[] = MessagePeer::DEL_FLG;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 11; // 11 = MessagePeer::NUM_COLUMNS - MessagePeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(MessagePeer::APP_ID)) $criteria->add(MessagePeer::APP_ID, $this->app_id);
		if ($this->isColumnModified(MessagePeer::VIDEO_ID)) $criteria->add(MessagePeer::VIDEO_ID, $this->video_id);
		if ($this->isColumnModified(MessagePeer::USER_ID)) $criteria->add(MessagePeer::USER_ID, $this->user_id);
		if ($this->isColumnModified(MessagePeer::NAME)) $criteria->add(MessagePeer::NAME, $this->name);
		if ($this->isColumnModified(MessagePeer::EMAIL)) $criteria->add(MessagePeer::EMAIL, $this->email);
		if ($this->isColumnModified(MessagePeer::ZIP)) $criteria->add(MessagePeer::ZIP, $this->zip);
		if ($this->isColumnModified(MessagePeer::COMMENT)) $criteria->add(MessagePeer::COMMENT, $this->comment);
		if ($this->isColumnModified(MessagePeer::DEL_FLG)) $criteria->add(MessagePeer::DEL_FLG, $this->del_flg);
