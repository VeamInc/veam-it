...
abstract class BaseGenre extends BaseObject  implements Persistent {
	...
	/**
	 * Initializes internal state of BaseGenre object.
	 * @see        applyDefaults()
	 */
	...
	public function setAppId($v)
	{
		...
		if ($this->app_id !== $v) {
			$this->app_id = $v;
			$this->modifiedColumns[] = GenrePeer::APP_ID;
		}
	...
	public function setDelFlg($v)
	{
		...
		if ($this->del_flg !== $v || $this->isNew()) {
			$this->del_flg = $v;
			$this->modifiedColumns[] = GenrePeer::DEL_FLG;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 6; // 6 = GenrePeer::NUM_COLUMNS - GenrePeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(GenrePeer::APP_ID)) $criteria->add(GenrePeer::APP_ID, $this->app_id);
		if ($this->isColumnModified(GenrePeer::DEL_FLG)) $criteria->add(GenrePeer::DEL_FLG, $this->del_flg);
