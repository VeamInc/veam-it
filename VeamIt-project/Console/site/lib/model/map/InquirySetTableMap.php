...
/**
 * This class defines the structure of the 'inquiry_set' table.
 *
 *
 ...
 */
class InquirySetTableMap extends TableMap {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'lib.model.map.InquirySetTableMap';
	...
	{
	  // attributes
		$this->setName('inquiry_set');
		$this->setPhpName('InquirySet');
		$this->setClassname('InquirySet');
