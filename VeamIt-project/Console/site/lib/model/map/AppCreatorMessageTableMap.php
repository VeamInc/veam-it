...
/**
 * This class defines the structure of the 'app_creator_message' table.
 *
 *
 ...
 */
class AppCreatorMessageTableMap extends TableMap {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'lib.model.map.AppCreatorMessageTableMap';
	...
	{
	  // attributes
		$this->setName('app_creator_message');
		$this->setPhpName('AppCreatorMessage');
		$this->setClassname('AppCreatorMessage');
