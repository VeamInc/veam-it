...
/**
 * This class defines the structure of the 'video_source' table.
 *
 *
 ...
 */
class VideoSourceTableMap extends TableMap {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'lib.model.map.VideoSourceTableMap';
	...
	{
	  // attributes
		$this->setName('video_source');
		$this->setPhpName('VideoSource');
		$this->setClassname('VideoSource');
