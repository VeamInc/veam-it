...
class ForumTableMap extends TableMap {
	 ...
	 */
	const CLASS_NAME = 'lib.model.map.ForumTableMap';
	...
	public function initialize()
	{
	  // attributes
		...
		$this->addColumn('NUMBER_OF_COMMENTS', 'NumberOfComments', 'INTEGER', true, 11, null);
		$this->addColumn('NUMBER_OF_PICTURES', 'NumberOfPictures', 'INTEGER', true, 11, null);
