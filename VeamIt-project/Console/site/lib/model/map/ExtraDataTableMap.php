...
/**
 * This class defines the structure of the 'extra_data' table.
 *
 *
 ...
 */
class ExtraDataTableMap extends TableMap {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'lib.model.map.ExtraDataTableMap';
	...
	{
	  // attributes
		$this->setName('extra_data');
		$this->setPhpName('ExtraData');
		$this->setClassname('ExtraData');
