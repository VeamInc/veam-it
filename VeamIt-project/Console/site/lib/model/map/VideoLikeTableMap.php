...
/**
 * This class defines the structure of the 'video_like' table.
 *
 *
 ...
 */
class VideoLikeTableMap extends TableMap {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'lib.model.map.VideoLikeTableMap';
	...
	{
	  // attributes
		$this->setName('video_like');
		$this->setPhpName('VideoLike');
		$this->setClassname('VideoLike');
