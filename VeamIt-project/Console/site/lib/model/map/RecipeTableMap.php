...
class RecipeTableMap extends TableMap {
	 ...
	 */
	const CLASS_NAME = 'lib.model.map.RecipeTableMap';
	...
	public function initialize()
	{
	  // attributes
		...
		$this->addColumn('RECIPE_CATEGORY_ID', 'RecipeCategoryId', 'INTEGER', true, 11, null);
		$this->addColumn('TITLE', 'Title', 'LONGVARCHAR', true, null, null);
		$this->addColumn('IMAGE_URL', 'ImageUrl', 'LONGVARCHAR', true, null, null);
		$this->addColumn('INGREDIENTS', 'Ingredients', 'LONGVARCHAR', true, null, null);
		$this->addColumn('DIRECTIONS', 'Directions', 'LONGVARCHAR', true, null, null);
		$this->addColumn('NUTRITION', 'Nutrition', 'LONGVARCHAR', true, null, null);
