...
class QuestionTableMap extends TableMap {
	...
	public function initialize()
	{
	  // attributes
		...
		$this->addColumn('NUMBER_OF_LIKES', 'NumberOfLikes', 'INTEGER', true, 11, 0);
		$this->addColumn('ANSWER_KIND', 'AnswerKind', 'INTEGER', true, 11, 0);
		$this->addColumn('ANSWER_ID', 'AnswerId', 'INTEGER', true, 11, 0);
		$this->addColumn('DEL_FLAG', 'DelFlag', 'INTEGER', true, 11, 0);
		$this->addColumn('ANSWERED_AT', 'AnsweredAt', 'TIMESTAMP', false, null, null);
