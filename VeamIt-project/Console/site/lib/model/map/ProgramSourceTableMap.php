...
/**
 * This class defines the structure of the 'program_source' table.
 *
 *
 ...
 */
class ProgramSourceTableMap extends TableMap {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'lib.model.map.ProgramSourceTableMap';
	...
	{
	  // attributes
		$this->setName('program_source');
		$this->setPhpName('ProgramSource');
		$this->setClassname('ProgramSource');
