...
/**
 * This class defines the structure of the 'stamp' table.
 *
 *
 ...
 */
class StampTableMap extends TableMap {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'lib.model.map.StampTableMap';
	...
	public function initialize()
	{
	  // attributes
		$this->setName('stamp');
		$this->setPhpName('Stamp');
		$this->setClassname('Stamp');
