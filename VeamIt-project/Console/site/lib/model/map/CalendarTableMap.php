...
class CalendarTableMap extends TableMap {
	 ...
	 */
	const CLASS_NAME = 'lib.model.map.CalendarTableMap';
	...
	public function initialize()
	{
	  // attributes
		...
		$this->addColumn('FIXED_CALENDAR_ID', 'FixedCalendarId', 'INTEGER', true, 11, 0);
		$this->addColumn('YYMMDD', 'Yymmdd', 'INTEGER', true, 11, null);
