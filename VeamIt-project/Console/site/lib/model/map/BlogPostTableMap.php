...
class BlogPostTableMap extends TableMap {
	 ...
	 */
	const CLASS_NAME = 'lib.model.map.BlogPostTableMap';
	...
	public function initialize()
	{
	  // attributes
		...
		$this->addColumn('BLOG_CATEGORY_ID', 'BlogCategoryId', 'INTEGER', true, 11, null);
		$this->addColumn('BLOG_SUB_CATEGORY_ID', 'BlogSubCategoryId', 'INTEGER', true, 11, null);
		$this->addColumn('THUMBNAIL_URL', 'ThumbnailUrl', 'LONGVARCHAR', true, null, null);
		$this->addColumn('POSTED_AT', 'PostedAt', 'TIMESTAMP', false, null, null);
