...
/**
 * This class defines the structure of the 'pdf_source' table.
 *
 *
 ...
 */
class PdfSourceTableMap extends TableMap {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'lib.model.map.PdfSourceTableMap';
	...
	{
	  // attributes
		$this->setName('pdf_source');
		$this->setPhpName('PdfSource');
		$this->setClassname('PdfSource');
