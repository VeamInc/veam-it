...
/**
 * CalendarMonth form base class.
 *
 * @method CalendarMonth getObject() Returns the current form's model object
 *
 * @package    console
 * @subpackage form
 * @author     Your name here
 */
abstract class BaseCalendarMonthForm extends BaseFormPropel
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('calendar_month[%s]');
