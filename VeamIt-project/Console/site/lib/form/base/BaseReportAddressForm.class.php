...
/**
 * ReportAddress form base class.
 *
 * @method ReportAddress getObject() Returns the current form's model object
 *
 * @package    console
 * @subpackage form
 * @author     Your name here
 */
abstract class BaseReportAddressForm extends BaseFormPropel
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('report_address[%s]');
