...
/**
 * MixedSubCategory form base class.
 *
 * @method MixedSubCategory getObject() Returns the current form's model object
 *
 * @package    console
 * @subpackage form
 * @author     Your name here
 */
abstract class BaseMixedSubCategoryForm extends BaseFormPropel
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('mixed_sub_category[%s]');
