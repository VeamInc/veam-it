...
/**
 * TemplateSubscription form base class.
 *
 * @method TemplateSubscription getObject() Returns the current form's model object
 *
 * @package    console
 * @subpackage form
 * @author     Your name here
 */
abstract class BaseTemplateSubscriptionForm extends BaseFormPropel
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'layout'          => new sfWidgetFormTextarea(),
      'kind'            => new sfWidgetFormTextarea(),
    ...
    $this->setValidators(array(
      ...
      'layout'          => new sfValidatorString(),
      'kind'            => new sfValidatorString(),
    ...
    $this->widgetSchema->setNameFormat('template_subscription[%s]');
