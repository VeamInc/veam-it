...
/**
 * QuestionLike form base class.
 *
 * @method QuestionLike getObject() Returns the current form's model object
 *
 * @package    console
 * @subpackage form
 * @author     Your name here
 */
abstract class BaseQuestionLikeForm extends BaseFormPropel
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'question_id'    => new sfValidatorInteger(array('min' => -2147483648, 'max' => 2147483647)),
    ...
    $this->widgetSchema->setNameFormat('question_like[%s]');
