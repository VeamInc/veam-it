...
/**
 * VideoSubCategory form base class.
 *
 * @method VideoSubCategory getObject() Returns the current form's model object
 *
 * @package    console
 * @subpackage form
 * @author     Your name here
 */
abstract class BaseVideoSubCategoryForm extends BaseFormPropel
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('video_sub_category[%s]');
