...
/**
 * RemoteCommand form base class.
 *
 * @method RemoteCommand getObject() Returns the current form's model object
 *
 * @package    console
 * @subpackage form
 * @author     Your name here
 */
abstract class BaseRemoteCommandForm extends BaseFormPropel
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('remote_command[%s]');
