...
/**
 * AudioCategory form base class.
 *
 * @method AudioCategory getObject() Returns the current form's model object
 *
 * @package    console
 * @subpackage form
 * @author     Your name here
 */
abstract class BaseAudioCategoryForm extends BaseFormPropel
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('audio_category[%s]');
