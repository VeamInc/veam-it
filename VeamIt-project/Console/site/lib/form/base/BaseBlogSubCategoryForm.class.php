...
/**
 * BlogSubCategory form base class.
 *
 * @method BlogSubCategory getObject() Returns the current form's model object
 *
 * @package    console
 * @subpackage form
 * @author     Your name here
 */
abstract class BaseBlogSubCategoryForm extends BaseFormPropel
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('blog_sub_category[%s]');
