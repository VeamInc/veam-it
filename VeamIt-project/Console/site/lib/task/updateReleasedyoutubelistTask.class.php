...
class updateReleasedyoutubelistTask extends sfBaseTask
{
  protected function configure()
  {
    ...
    $this->namespace        = '';
    $this->name             = 'updateReleasedyoutubelist';
    $this->briefDescription = '';
    $this->detailedDescription = <<<EOF
The [updateReleasedyoutubelist|INFO] task does things.
Call it with:

  [php symfony updateReleasedyoutubelist|INFO]
EOF;
  }
	...
	protected function execute($arguments = array(), $options = array())
	{
		...
		$c = new Criteria() ;
		$c->addJoin(YoutubeUserPeer::APP_ID,AppPeer::ID) ;
		if($targetAppId){
