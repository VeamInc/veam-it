...
public class PdfCategoryObject implements HandlePostResultInterface {

	private SQLiteDatabase mDb ;

	private final String TABLE_NAME = "pdf_category" ;
	...
	public PdfCategoryObject(SQLiteDatabase db, String id)
	{
		mExistsRecord = false ;
	...
	public PdfCategoryObject(String id, String name, String displayOrder, String updateTimeId){
		this.id = id ;
		this.name = name ;
		this.displayOrder = displayOrder ;
	...
	public PdfCategoryObject(Attributes attributes){
	...
	public void save()
	{
		...
		if(this.mExistsRecord){
			// update
			VeamUtil.updatePdfCategory(mDb, id, name, displayOrder, updateTimeId) ;
		} else {
			// insert
			VeamUtil.insertPdfCategory(mDb, id, name, displayOrder, updateTimeId) ;
