...
public class TouchInterceptor extends ListView {
    ...
    private ConsoleBaseAdapter consoleBaseAdapter ;
    private int x1 = 0 ;
    private int x2 = 0 ;
    private boolean isDraggable = false ;

    public void setConsoleBaseAdapter(ConsoleBaseAdapter consoleBaseAdapter){
        this.consoleBaseAdapter = consoleBaseAdapter ;
        super.setAdapter(consoleBaseAdapter);

        mItemHeightNormal = consoleBaseAdapter.getCellHeight() ;
        mItemHeightHalf = mItemHeightNormal / 2;
        mItemHeightExpanded = mItemHeightNormal * 2 ;

        isDraggable = consoleBaseAdapter.isDraggable() ;
        x1 = consoleBaseAdapter.getDraggableX1() ;
        x2 = consoleBaseAdapter.getDraggableX2() ;
    }
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        VeamUtil.log("debug", "onInterceptTouchEvent") ;
        if(isDraggable) {
            ...
            if (mDragListener != null || mDropListener != null) {
                VeamUtil.log("debug", "DragDrop Check");
                switch (ev.getAction()) {
    ...
    private void doExpansion() {
        ...
        VeamUtil.log("debug","numheaders"+numheaders) ;
        ...
        for (int i = 0;; i++) {
            ...
            if(height == mItemHeightExpanded){
                vv.setPadding(0,mItemHeightNormal,0,0);
            } else {
