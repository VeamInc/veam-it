...
public class DeletePictureTask extends AsyncTask<String, Integer, Integer> {
	
	final String TAG = "DeletePictureTask";
	private VeamActivity veamActivity ;
	private PictureObject pictureObject ;
	

	// コンストラクタ  
    public DeletePictureTask(VeamActivity activity,PictureObject pictureObject) {
    ...
    protected Integer doInBackground(String... urls) {
    	...
    	String urlString = String.format("%s&p=%s&sid=%s&s=%s",VeamUtil.getApiUrlString(veamActivity, "forum/deletepicture"),pictureId,socialUserId,signature) ;
	...
	protected void onPostExecute(Integer resultCode) {
		...
		veamActivity.deletePictureDone(resultCode,pictureObject) ;
	}
}
