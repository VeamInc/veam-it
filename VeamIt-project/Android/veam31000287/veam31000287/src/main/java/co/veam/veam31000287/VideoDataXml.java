...
public class VideoDataXml extends DefaultHandler {

	int numberOfLikes ;
	String videoId ;
	boolean isLike = false ;
	ArrayList<VideoCommentObject> comments ;
	...
	*/
	public void startDocument() {
		...
		comments = new ArrayList<VideoCommentObject>();
	}
	...
	*/
	public void startElement(String uri,String localName,String qName,Attributes attributes) {
		 ...
		 * */
		if(tag.equals("video")){
	    	videoId = attributes.getValue("id") ;
	        ...
	        VideoCommentObject comment = new VideoCommentObject(id,videoId,socialUserId,userName,text) ;
	        comments.add(comment) ;
	    } else if(tag.equals("video_like")){
	...
	*/
	...
	public ArrayList<VideoCommentObject> getComments(){
		return comments ;
	}
	
	public VideoCommentObject getCommentAt(int index){
		VideoCommentObject retComment = null ;
