 ...
 */
public class ConsoleEditSellSectionAudioAdapter extends ConsoleBaseAdapter {
    ...
    public ConsoleEditSellSectionAudioAdapter(ConsoleActivity consoleActivity)
    {
    ...
    public void setNewValue(int position,String newValue){
        VeamUtil.log("debug", "ConsoleEditSellSectionAudioAdapter::setNewValue " + position + " " + newValue) ;
        switch (position){
            case 1:
                title = newValue ;
                break ;
