 ...
 */
public class ConsoleEditSectionDescriptionActivity extends ConsoleActivity {

    ConsoleEditSectionDescriptionAdapter adapter ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new ConsoleEditSectionDescriptionAdapter(this) ;
    ...
    public void saveData(){
        ...
        consoleContents.setAppData(adapter.getDescription(),ConsoleUtil.CONSOLE_SECTION_DESCRIPTION_KEY);
    }
