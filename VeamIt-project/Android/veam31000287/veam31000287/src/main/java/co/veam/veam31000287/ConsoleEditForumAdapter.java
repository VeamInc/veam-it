 ...
 */
public class ConsoleEditForumAdapter extends ConsoleBaseAdapter {

    private String title ;

    public ConsoleEditForumAdapter(ConsoleActivity consoleActivity,String title)
    {
    ...
    public Object getItem(int position) {
        ...
        switch (position){
            case 0:
                item = new ConsoleAdapterElement(0,ConsoleAdapterElement.KIND_SMALL_TITLE, ConsoleBaseAdapter.COLOR_TYPE_LEFT_BLACK,"Forum", " ",null);
                break ;
            case 1:
    ...
    public void setNewValue(int position,String newValue){
        VeamUtil.log("debug", "ConsoleEditForumAdapter::setNewValue " + position + " " + newValue) ;
        switch (position){
            case 1:
                title = newValue ;
                break ;
