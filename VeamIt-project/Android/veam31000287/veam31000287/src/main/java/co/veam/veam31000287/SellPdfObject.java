...
public class SellPdfObject {

	private SQLiteDatabase mDb ;

	private final String TABLE_NAME = "sell_pdf" ;
	...
	public SellPdfObject(SQLiteDatabase db, String id)
	{
		mExistsRecord = false ;
	...
	public SellPdfObject(String id, String pdfId, String productId, String price, String priceText, String description, String buttonText, String displayOrder, String updateTimeId){
		this.id = id ;
		this.pdfId = pdfId ;
		this.productId = productId ;
        this.priceText = priceText ;
	...
	public void save()
	{
		...
		if(this.mExistsRecord){
			// update
			VeamUtil.updateSellPdf(mDb, id, pdfId, productId, price, priceText, description, buttonText, displayOrder, updateTimeId);
		} else {
			// insert
			VeamUtil.insertSellPdf(mDb, id, pdfId, productId, price, priceText, description, buttonText, displayOrder, updateTimeId);
